...
export class ListAllComponent implements OnInit {
  ...
  constructor(private activedRoute:ActivatedRoute,
    private _service:AccountServiceService,private servicetrans:TransactionService,private toastr:ToastrService) { }
  ...
  getAllTransactions(id_account:any){
    if(id_account){
      ...
      this.servicetrans.getTransactions().subscribe(
        res =>{
  ...
  deleteTransaction(id:any){
    this.servicetrans.deleteTransactions(id).subscribe(
      res => {
        this.toastr.success("Deletion","Transaction has been deleted!");
        this.ngOnInit();
      },()=>{
        this.toastr.error("Deletetion","An error has been occured! please contact support");
      }
    )
  }
